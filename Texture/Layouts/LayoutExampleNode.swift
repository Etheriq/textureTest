...
class PhotoWithInsetTextOverlay : LayoutExampleNode {
    ...
    required init() {
        ...
        photoNode.url = URL(string: "https://texturegroup.org/static/images/layout-examples-photo-with-inset-text-overlay-photo.png")
...
class PhotoWithOutsetIconOverlay : LayoutExampleNode {
    ...
    required init() {
        ...
        photoNode.url = URL(string: "https://texturegroup.org/static/images/layout-examples-photo-with-outset-icon-overlay-photo.png")
        
        iconNode.url = URL(string: "https://texturegroup.org/static/images/layout-examples-photo-with-outset-icon-overlay-icon.png")
